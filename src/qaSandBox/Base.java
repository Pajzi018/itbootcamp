...
public class Base {
	...
	public WebDriverWait waiter() {
		WebDriverWait wait = new WebDriverWait(getWebDriver(), 500);
		return wait;
	}
	...
	public void attributeContains(By locator, java.lang.String attribute, String value) {
		waiter().until(ExpectedConditions.attributeContains(locator, attribute, value));
	}

	public void attributeContains(WebElement element, java.lang.String attribute, java.lang.String value) {
		waiter().until(ExpectedConditions.attributeContains(element, attribute, value));
	}

	public void attributeToBe(By locator, java.lang.String attribute, java.lang.String value) {
		waiter().until(ExpectedConditions.attributeToBe(locator, attribute, value));
	}

	public void attributeToBe(WebElement element, java.lang.String attribute, java.lang.String value) {
	...
	public void numberOfwindowsToBe(int expectedNumberOfWindows) {
		waiter().until(ExpectedConditions.numberOfWindowsToBe(expectedNumberOfWindows));
	}
